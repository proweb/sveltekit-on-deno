...
// node_modules/.deno/uikit@3.25.9/node_modules/uikit/dist/js/uikit.js
var require_uikit = __commonJS({
  "node_modules/.deno/uikit@3.25.9/node_modules/uikit/dist/js/uikit.js"(exports, module) {
    (function(global, factory) {
      ...
      function preventBackgroundScroll(el) {
        ...
        const props2 = {
          ...
          touchAction: "none",
          scrollbarGutter: width(window) - scrollingElement2.clientWidth ? "stable" : ""
        };
      ...
      var SliderNav = {
        ...
        computed: {
          ...
          navChildren() {
            return this.nav.map((nav2) => children(nav2)).flat();
          },
        ...
        methods: {
          ...
          padNavitems() {
            for (const nav2 of this.nav) {
              const navChildren = children(nav2);
              const navItems = [];
      ...
      var slider = {
        ...
        methods: {
          reorder() {
            ...
            let width2 = (dimensions$1(this.list).width - dimensions$1(next).width) / 2;
            let j = 0;
            while (width2 > 0) {
          ...
          getAdjacentSlides() {
            ...
            const slideLeft = this.center ? (width2 - slideWidth) / 2 : 0;
          ...
          getIndexAt(percent2) {
            ...
            do {
              ...
              const slideDist = this.center ? (slideWidth + dimensions$1(this.slides[index2 + 1]).width) / 2 : slideWidth;
      ...
      function isFinite(list, center) {
        ...
        for (const index2 in slides) {
          ...
          for (const i of [-1, 1]) {
            ...
            diff = Math.max(
              diff,
              (slideWidth + dimensions$1(slides[getIndex(+index2 + i, slides)]).width) / 2 - (left - listHalf)
            );
          }
        ...
        events: [
          {
            ...
            handler(e) {
              ...
              maybeDefaultPreventClick(e);
              const off2 = keepScrollPosition(e.target);
              this.toggle(item).finally(off2);
            }
          },
          {
      ...
      async function transition(el, show, { content, duration, velocity, transition: transition2 }) {
        ...
        duration = endHeight ? (velocity * endHeight + duration) * (show ? 1 - percent2 : percent2) : 0;
        ...
        methods: {
          ...
          hide(delay = true, animate2 = true) {
            const hide2 = () => {
              ...
              this.toggleElement(this.$el, false, this.animateOut && animate2);
            };
            this.clearTimers();
      ...
      function handleMouseDrag(e) {
        ...
        e.preventDefault();
        const pointerOptions2 = { passive: false, capture: true };
        const { $el: el, threshold, $options } = this;
        let started;
        const off2 = on(document, pointerMove$1, move(e), pointerOptions2);
        ...
        function end() {
          off2();
          if (started) {
            setTimeout(on(el, "click", (e2) => e2.preventDefault(), pointerOptions2));
          }
        }
      }
      var responsive = {
            ...
            write(data2) {
              for (const [el, state] of this.elementData.entries()) {
                if (state.show && !state.inview && !state.queued) {
                  state.queued = true;
                  data2.promise = (data2.promise || Promise.resolve()).then(async () => {
